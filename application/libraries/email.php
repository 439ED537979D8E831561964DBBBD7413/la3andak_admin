...
class Email {
    ...
    function _SetupHeaders() {
        ...
        $headers .= 'X-Spam-Status: No' . $this->_newline;
        $headers .= 'X-Priority: 3' . $this->_newline;
        $headers .= 'X-MSmail-Priority: high' . $this->_newline;
        $headers .= "X-Mailer: PHP" . phpversion() . $this->_newline;
