	...
	exit(); ?>
		...
		<?php  if(isset($_GET['order_code']) && !empty($_GET['order_code']) )
		 { 
			...
			<div style="width:45vw;background: black;height: 66px;">
		    	<?php $image_url= $this->config->item("upload_url") ;?>
            <a href="javascript:void(0)" class="site_title">
            <img src="<?php echo $image_url; ?>/images/logo.png" height="30px;" style="margin-left:38%;margin-top:3%;"></a>		
		    </div>
								...
								if($query1){
										...
										for($i=0;$i<count($row1);$i++)											
									{
						                ...
						                <tr class="text-center">
								          	...
								          	<td><?php echo CURRENCY_CONSTANT."  ".$row1[$i]['product_price']?></td>
								          	...
								          	<td><?php echo CURRENCY_CONSTANT."  ".round($row1[$i]['product_total_price'],2); ?></td>						    
								          </tr>
										<?php 
									} 
									?>
