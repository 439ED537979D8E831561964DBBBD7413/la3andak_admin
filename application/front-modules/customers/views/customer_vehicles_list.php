                                    ...
                                    <form id="location_form" method="post" action="" class="form-horizontal form-label-left input_mask">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9 col-sm-9 col-xs-12 custom-select">
                                                    <input required="required" id="model_year" name="model_year" onkeypress="return isNumberKey(event)" maxlength="4" class="form-control col-md-7 col-xs-12" type="text" value="">
                                                </div>
                                            </div>
                                            <div class="form-group">
...
$('#vehicle').on('hidden.bs.modal', function () {
   ...
   var url='<?php echo $this->config->item("site_url")."get_vehicle?cust_id=".urlencode($this->general->encryptData($customer["cust_id"])) ?>';
    ...
    $.post(url, {
        ...
        if(res.status==1){
            ...
            $("#type option:selected" ).val(vehicle.type);
