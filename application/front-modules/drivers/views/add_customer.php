                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12 custom-select">
                                <input id="fullname" name="fullname" class="form-control col-md-7 col-xs-12" type="text" value="<?php echo ($all['fullname'] != '') ? $all['fullname'] : ''; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                <input id="email" name="email" class="form-control col-md-7 col-xs-12" type="text" value="<?php echo ($all['email'] != '') ? $all['email'] : ''; ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                <input id="phone" name="phone" class="form-control col-md-7 col-xs-12" type="text" value="<?php echo ($all['cust_id'] != '') ? $all['phone'] : ''; ?>">
                            </div>
                        </div>
                        <div class="form-group">
