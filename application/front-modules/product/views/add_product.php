                    ...
                    <div class="col-md-9">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                <input id="offer_start_date" name="offer_start_date" class="form-control col-md-7 col-xs-12" type="date">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                <input id="offer_end_date" name="offer_end_date" class="form-control col-md-7 col-xs-12" type="date">
                            </div>
                        </div>
