            ...
            <div class="x_content">
                ...
                <form id="customer_form" method="post" enctype="multipart/form-data" class="form-horizontal form-label-left input_mask" action="<?php echo $this->config->item("site_url") . "product/product_action_edit" ?>">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Brand Name<span class="required">*</span></label>
                            <div class="col-md-9 col-sm-9 col-xs-12 custom-select">
                                <?php
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Categoty Name<span class="required">*</span></label>
                            <div class="col-md-9 col-sm-9 col-xs-12 custom-select">
                                <?php
                                echo '<select name="category_id" onChange="get_sub_category_ajax(this.value)" id="category_id" class="form-control" >';
                        ...
                        <div class="form-group" id="productAjax">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Sub Categoty Name<span class="required">*</span></label>
                            <div class="col-md-9 col-sm-9 col-xs-12 custom-select">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                <input id="offer_start_date" name="offer_start_date" value="<?php echo ($product[0]['offer_start_date'] != '') ? date("d-m-Y", strtotime($product[0]['offer_start_date'])) : ''; ?>" class="form-control col-md-7 col-xs-12" type="text">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                <input id="offer_end_date" name="offer_end_date" value="<?php echo ($product[0]['offer_end_date'] != '') ? date("d-m-Y", strtotime($product[0]['offer_end_date'])) : ''; ?>" class="form-control col-md-7 col-xs-12" type="text">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Max Product Quantity Limit<span class="required">*</span></label>
                            <div class="col-md-9 col-sm-9 col-xs-12 custom-select">
