...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <br />
               <form id="customer_form" method="post" enctype="multipart/form-data" class="form-horizontal form-label-left input_mask" action="<?php echo $this->config->item("site_url") . "promocode/promocode_edit_action" ?>">  
...
<!-- 
                          <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12 custom-select">
                                  <textarea name="promocode_description" class="form-control" id="promocode_description" placeholder="Promocode Description" required><?php echo ($promocode[0]['promocode_description'] != '') ? $this->general_function->decodeEmoji($promocode[0]['promocode_description']) : ''; ?></textarea>
                            </div>
                        </div> 
 -->
