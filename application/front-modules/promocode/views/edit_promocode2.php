                        ...
                        <div class="form-group" id="date_picker" >
                            ...
                            <div class="col-md-4 col-sm-4 col-xs-12 custom-select" style="margin-top:-13px;margin-left: 60px; ">
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="text" placeholder="Date Range From" name="date" id="events_date" class="form-control" value="<?php echo ($promocode[0]['promocode_start_date'] != '' && $promocode[0]['promocode_start_date'] != '0000-00-00') ? date('d-m-Y', strtotime($promocode[0]['promocode_start_date'])) : ''; ?>">
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-4 col-xs-12 custom-select" style="margin-top:-13px;margin-left:20px; ">
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="text" placeholder="Date Range To" name="date1" id="events_date1" class="form-control" value="<?php echo ($promocode[0]['promocode_end_date'] != '' && $promocode[0]['promocode_end_date'] != '0000-00-00') ? date('d-m-Y', strtotime($promocode[0]['promocode_end_date'])) : ''; ?>">
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    $('#always_available').change(function () {
        if ($(this).is(":checked")) {
            ...
            $('#date_picker').addClass('inactiveclass');
        } else {
            // $('#threshold_quantity_div').addClass('activeclass');
            $('#date_picker').removeClass('inactiveclass');
        }
    });
