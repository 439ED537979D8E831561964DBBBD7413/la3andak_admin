        ...
        <div id="wrapper">
            <div id="login" class="animate form">
                <section class="login_content">
                    <form method="POST" name="resetpass" id="resetpass" action="<?php echo $this->config->item("site_url") . 'content/reset_password_action' ?>"  role="form">      
                        <?php $image_url= $this->config->item("upload_url") ;

                        $html.='<img src="'.$image_url.'/images/2.png"  height="25px" style="margin: -32px -5px 8px 7px;">';
