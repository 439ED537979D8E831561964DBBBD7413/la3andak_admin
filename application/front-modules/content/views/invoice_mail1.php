                                    ...
                                    <table class="table-condensed"  width="100%;" border="1" style="outline: thin solid black;">
                                        ...
                                        <tbody>
                                            ...
                                            if ($query1) {
                                                ...
                                                <tr>
                                                    <td  colspan="4" style="text-align: right;padding-right: 15px;"><b> Coupon Code & Discount: <?php echo isset($row[0]['promocode']) ? $row[0]['promocode'] : 0; ?></b></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center" style="text-align: center;"><b><?php echo round(isset($row[0]['delivery_charge']) ? $row[0]['delivery_charge'] : 0, 2); ?></td>
                                                </tr>
