            ...
            <div class="x_content">
                ...
                <div data-example-id="togglable-tabs" role="tabpanel" class="">
                    <ul role="tablist" class="nav nav-tabs bar_tabs" id="myTab">
                        ...
                        <li class="" role="presentation"><a aria-expanded="false" data-toggle="tab" role="tab" id="aboutApp" href="#tab_content4">FAQs</a>
                        </li>
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div aria-labelledby="aboutApp" id="tab_content4" class="tab-pane fade in" role="tabpanel">
                            <div class="form-group">
                                <label class="control-label col-md-2 col-sm-3 col-xs-12">FAQs</label>
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <textarea name="about_app" id="about_app" class="ckeditor" rows = "4"><?php echo $faqs; ?></textarea>
                                </div>
                            </div>
                        </div>
