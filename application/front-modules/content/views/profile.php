        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <form id="profile_form" method="post" action="<?php echo $this->config->item("site_url") . "content/profile_action" ?>"class="form-horizontal form-label-left input_mask" enctype="multipart/form-data">
                    <input type="hidden" name="aid" id="aid" value="<?php echo ($all['seller_id'] != '') ? $all['seller_id'] : ''; ?>"/>
                    <input type="hidden" name="chnagepass" id="chnagepassval" value="0"/>
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">First Name<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input id="firstname" name="firstname" class="form-control col-md-7 col-xs-12" type="text" value="<?php echo ($all['seller_id'] != '') ? $all['seller_english_name'] : ''; ?>">
                        </div>
                    </div>
                    <!-- <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input id="lastname" name="lastname" class="form-control col-md-7 col-xs-12" type="text" value="<?php echo ($all['seller_id'] != '') ? $all['vLastName'] : ''; ?>">
                        </div>
                    </div> -->
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input id="email" name="email" class="form-control col-md-7 col-xs-12" type="text" value="<?php echo ($all['seller_id'] != '') ? $all['seller_username'] : ''; ?>">
                        </div>
                    </div>
                    ...
                    <?php } else { ?>
                        <div class="form-group">                                        
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                if ($all['vImage'] != '') {
                                    $img = 'admin/' . $all['seller_id'] . '/' . $all['vImage'];
                                ...
                                if($all['seller_logo']!="")
                                {
                                    if($all['seller_logo']!="no_image.png")
                                    {

                                        $imageWithPath = TABLE_ADMIN_PROFILE.$all['seller_logo'];

                                    
                                        $imageHTML = $this->general_function->showImage_profile($all['seller_logo'],$imageWithPath,$brand[0]['brand_id']);
                                        echo $imageHTML;
                                    }
                                    elseif ($all['seller_logo']=="no_image.png") 
                                    {
                                       $imageWithPath = TABLE_ADMIN_PROFILE.$all['seller_logo'];
                                        $imageHTML = $this->general_function->showImage1($all['seller_logo'],$imageWithPath,$brand[0]['brand_id']);
                                        echo $imageHTML;
                                    }
                                ...
                                <?php if ($img_url != '') { ?>
                                    <div class="avatar-view" title="" id="vProfileImg">
                                        ...
                                        <img src="<?php echo $this->config->item('upload_url') . 'admin/' . $all['seller_id'] . '/' . $all['vImage']; ?>"  alt="photo" class="img-responsive" style="height: 150px"></a>
