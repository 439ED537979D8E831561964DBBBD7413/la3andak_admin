...
<?php //var_dump(date('H:i:s')) ?>
<div class="row">
   <!--  <div class="col-md-12">
        <div class="x_content">
          <!--   <div class="x_content">
                <div class="col-md-4">
                   <?php echo count($user_number); ?>
                </div>
                <div class="col-md-4">
                    <?php echo count($order_number); ?>
                </div>
                <div class="col-md-4">
                     <?php echo count($category_number); ?>
                </div>
            </div>  -->
<!--             <div class="col-md-4 col-xs-12 col-sm-4">
                <div class="panel purple">
                    ...
                    <div class="state-value">
                        <div class="value"> <?php echo count($user_number); ?></div>
                ...
                <div class="panel purple">
                    ...
                    <div class="state-value">
                        <div class="value"> <?php echo count($order_number); ?></div>
                        <div class="title">Total Category</div>
                    </div>
                </div>
            </div>
                ...
                <div class="panel purple">
                    ...
                    <div class="state-value">
                        <div class="value"><?php echo count($category_number); ?></div>
                        <div class="title">Total Category</div>
                    </div>
                </div>
            </div>
                    ...
                    <?php foreach ($orders as $key => $value)
                    {
                        ...
                        <tr>
                           ...
                           <td><?php echo $value['checkout_comment']; ?></td> 
                            ...
                            <td>
                            <?php if($value['order_status']!=5 && $value['order_status']!=4  && $value['order_status']!=2) { ?>
                            ...
                            <?php }
                               ...
                               <?php     }
                                    ...
                                    // {
                                    //    echo "Order already DELIVER";
                                    // }
                                    //  elseif ($value['order_status']==4)
                                    // {
                                    //    echo "Order is Cancel";
                                    // }
                                    //  elseif ($value['order_status']==2)
                                    // {
                             ...
                             ?>
                              ...
                              <td><?php if($value['order_status']==1)
                                      ...
                                      <?php
                                        ...
                                        {
                                            ?>
                                            <button disabled class="buttonbg" style="background-color:#8dd13d">Deliver</button>
                                      <?php
                                        } ?></td>
                        </tr>
                    <?php }
