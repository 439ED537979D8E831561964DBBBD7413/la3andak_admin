<div class="col-md-3 left_col newclass" style="height: 100%;background: #2A3F54">
    <div class="left_col scroll-view" style="background: #2A3F54">
        <div  style="border: 0;height: auto;">
           ...
           <!-- <a href="javascript:void(0)" class="site_title"> Grocery Image</a> -->
        </div>
        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu custom_bg">
           ...
           <?php
            ?>
            <!--
                      <li><a href="<?php echo $this->config->item("site_url"); ?>contact_us"><i class="fa fa-home"></i> Contact Us</a></li>
                     <li><a href="<?php echo $this->config->item("site_url")?>content_management"><i class="fa fa-home"></i> Content Management </a></li>
 -->
                </ul>
            </div>
        </div>
