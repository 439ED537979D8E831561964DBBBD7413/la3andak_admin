...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <br />
                <form id="customer_form" method="post" enctype="multipart/form-data" class="form-horizontal form-label-left input_mask" action="<?php echo $this->config->item("site_url") . "brand/brand_action" ?>">          
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12 custom-select">
                                <input id="brand_name" name="brand_name" class="required form-control col-md-7 col-xs-12" type="text" value="<?php echo ($all['brand_name'] != '') ? $all['brand_name'] : ''; ?>" required>
                            </div>
                        </div>
                        <div class="form-group">
