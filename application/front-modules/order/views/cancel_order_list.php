                ...
                <tbody>
...

                    {
                        ...
                        <tr class="">
                            ...
                            <a href="#myModal" data-toggle="modal" style="background: #2a3f54;text-align:center;width: 100%;" class="btn btn-default get myModal" onClick="Load_Contents_From_DB_by_Vasplus_Blog('<?php echo $value['order_id']; ?>');"><font color="white">View</a>
                            ...
                            <a href="invoice?order_code=<?php echo $value['order_code']; ?>" target="_blank" style="background: #2a3f54;text-align:center;width: 100%;" class="btn btn-default get"><font color="white">Print</a>

                            </td>

                           <!--  <td>

                            <a href="javascript:void(0);" onClick="MarkAsDeliver('<?php echo strip_tags($value['order_id']); ?>');" class="btn btn-default get">Deliver</a>



                            <a href="edit_order?order_code=<?php echo $value['order_code']; ?>" target="_blank" class="btn btn-default get">Edit</a>
